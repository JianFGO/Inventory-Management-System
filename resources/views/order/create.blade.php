                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="order_no" id="order_no" class="form-control" readonly value="{{$order_no}}" >
                                    </div>
                                        ...
                                        <thead>
                                            ...
                                            <tbody class="tbody">
                                                ...
                                                {{-- Category Selection --}}
                                                    ...
                                                    <td><input class="form-control" type="text" name="order_quantity[]" id="quantity_1" placeholder="Enter Quantity" onkeyup="calculateTotal(event)"></td>
                                                    {{-- Input for unit price --}}
                                                    <td><input class="form-control" type="text" name="unit_price[]" id="price_1" placeholder="Enter Unit Price" onkeyup="calculateTotal(event)"></td>
                                                    {{-- Displays Total price of selected product --}}
                                                    <td><input class="form-control total" type="text" id="total_1" placeholder="Total Price" disabled></td>
                                            ...
                                            {{-- Total price of the order --}}
                                                ...
                                                <th><input class="form-control" type="text" name="total_amount" id="total" placeholder="Item(s) Total" readonly></th>
                                            </tfoot>
                                    </table>
                                </div>
                            </div>
