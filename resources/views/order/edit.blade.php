                            ...
                            <div class="row">
                                ...
                                {{-- Table headers --}}
                                        <thead>
                                            ...
                                            {{-- Add product button --}}
                                            <button onclick="addProduct()" type="button" class="btn btn-success"><i class="fas fa-plus"></i></button>                                            
                                            </th>
                                        </thead>
                                            <tbody class="tbody">
                                            @foreach ($order->orderDetails as $item)
                                                ...
                                                {{-- Edit category selection --}}
                                                    ...
                                                    {{-- Edit order quantity --}}
                                                    <td><input class="form-control" type="text" name="order_quantity[]" id="quantity_1" placeholder="Enter Quantity" onkeyup="calculateTotal(event)" value="{{$item->order_quantity}}"></td>
                                                    {{-- Edit unit price --}}
                                                    <td><input class="form-control" type="text" name="unit_price[]" id="price_1" placeholder="Enter Unit Price" onkeyup="calculateTotal(event)" value="{{$item->unit_price}}"></td>
                                                    {{-- Displays Total price of selected product --}}
                                                    <td><input class="form-control total" type="text" id="total_1" placeholder="Total Price" value="{{$item->order_quantity * $item->unit_price}}" disabled></td>
                                            ...
                                            {{-- Total price of the order --}}
                                                ...
                                                <th><input class="form-control" type="text" name="total_amount" id="total" placeholder="Item(s) Total" value="{{$order->total_amount}}" readonly></th>
                                            </tfoot>
                                    </table> 
                                </div>
                            </div>
